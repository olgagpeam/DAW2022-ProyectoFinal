<%-- 
    Document   : categorySe
    Created on : Jun 10, 2022, 11:25:55 PM
    Author     : olgag
--%>
        ...
        <div id="container">
            <div id="left">
                <ul>
                    ...
                    <div class="dropdown-container">
                        <li><a href="/Veterinaria/CategorySeIn" class="active">Listado</a></li>
                    ...
                    <tbody>
                        <%
                            for (Category cat : cats) {
                                out.print("<tr>"
                                        + "<td>" + ((String.valueOf(cat.getId()) == null) ? "" : cat.getId()) + "</td>"
                                        + "<td>" + ((cat.getCategory() == null) ? "" : cat.getCategory()) + "</td>"
                                        + "</tr>");
                            }
                        %>
                    </tbody>
