<%-- 
    Document   : apptInH
    Created on : Jun 12, 2022, 9:29:27 PM
    Author     : olgag
--%>
        ...
        <div id="container">
            <div id="left">
                <ul>
                    ...
                    <li><a href="/Veterinaria/ApptHospR" class="active">Internar</a></li>
            ...
            <div id="form">
                ...
                <%
                    ...
                    if ((user != null && user.size() > 0) && (owner != null && owner.size() > 0)
                            && (pet != null && pet.size() > 0)) {
                %>
                <form method="post" action="/Veterinaria/ApptHospitalSeIn">
                    ...
                    <input type="textarea" name="illness" placeholder="Padecimiento">
                    ...
                    <input type="textarea" name="note"  placeholder="Observaciones">
