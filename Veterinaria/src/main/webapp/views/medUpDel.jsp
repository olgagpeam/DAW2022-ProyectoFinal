<%-- 
    Document   : medUpDel
    Created on : Jun 13, 2022, 5:35:47 PM
    Author     : olgag
--%>
<!--DOCTYPE html-->
<html lang="es">
        ...
        <div id="container">
            <div id="left">
                <ul>
                    ...
                    <div class="dropdown-container">
                        <li><a href="/Veterinaria/views/medUpDel.jsp" class="active">Medico</a></li>
            ...
            <div id="form">
                <div class="top">
                    Eliminar registro del historial medico
                </div>
                <form method="post" action="/Veterinaria/MedUpdateDel">
