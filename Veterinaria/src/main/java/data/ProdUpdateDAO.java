...
//  select    insert    update      delete
    ...
    public static final String insertSQL = "INSERT INTO prod_updates (r_prod, prod_updated_at, r_user_prod, updates) VALUES (?, ?, ?, ?)";
    public static final String updateSQL = "UPDATE prod_updates SET r_id = ?, med_updated_at = ?, r_user_med = ?, updates = ? WHERE id_produ = ?";
    ...
    public ArrayList<ProdUpdate> select() throws ParseException {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                prod = new ProdUpdate(id, r_id, updatedAt, r_user);
