 ...
 * @author Alarcon Olga
 */
@WebServlet(name = "ApptHospR", urlPatterns = {"/ApptHospR"})

public class ApptHospR extends HttpServlet{
    ...
    protected void doGet(HttpServletRequest rq, HttpServletResponse rp) throws IOException {
        ...
        try {
            ...
            rp.sendRedirect("/Veterinaria/views/apptInH.jsp");
        } catch (ParseException ex) {
            Logger.getLogger(ApptHospR.class.getName()).log(Level.SEVERE, null, ex);
        }
